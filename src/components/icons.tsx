// Centralized icons — Feather icon set ONLY (https://feathericons.com).
// 24×24 viewBox, no fill, currentColor stroke, width 2, round caps/joins.
// Do not add icons from other sets or ad-hoc SVGs.
